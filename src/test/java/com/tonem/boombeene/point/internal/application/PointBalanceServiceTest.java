...
class PointBalanceServiceTest {
    ...
    @Test
    void earnForCrowdReportCreatesPointForNewUser() {
        ...
        pointBalanceService.earnForCrowdReport(10L, 100L, false);
    ...
    @Test
    void earnForCrowdReportAddsPointToExistingUser() {
    ...
    @Test
    void earnForCrowdReportSkipsWhenIdempotencyKeyAlreadyExists() {
        String idempotencyKey = PointLedger.earnKey(10L, 100L);
